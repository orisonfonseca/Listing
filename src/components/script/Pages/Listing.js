    ...
    render() {
        ...
        return (
           ...
           <div className="container row justify-content-center mb-3">
            ...
            <input type="search" className="mt-5 bg-primary searchbar" name="search" placeholder="Search for an Anime eg. Naruto" 
            value={this.state.search} onChange={this.handle} onKeyDown={this.onkey}></input>

            <button className=" buttono mt-5" onClick={this.submit} >Go</button>
            </div>
